...
type StudentMascotMomentClientProps = {
  name: string;
  stars: number;
  streakDays: number;
...
export function StudentMascotMomentClient({
  name,
  stars,
  streakDays,
  pendingMissions,
  mascotImages,
}: StudentMascotMomentClientProps) {
  ...
  return (
    <section className="student-mascot-moment" aria-labelledby="mascot-moment-title">
      <div className="student-mascot-moment-character" aria-hidden="true">
        <Image src={mascotImage} alt="" width={180} height={180} />
      </div>
