...
export default async function StudentCourseDetail({params,searchParams}:{params:Promise<{slug:string}>;searchParams:Promise<{erro?:string;sucesso?:string}>}){
  ...
  return <>
    <PageHeader eyebrow="Curso Livre Curió" title={course.title} description={course.summary||course.description||"Uma trilha para aprender no seu ritmo."}/>
