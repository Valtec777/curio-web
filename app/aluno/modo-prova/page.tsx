...
export default async function StudentTestModePage(){
  ...
  return <>
    ...
    <section className="student-test-intro"><span className="student-test-intro-icon"><CurioIcon name="check" /></span><div><h2>Preparar também é aprender.</h2><p>Confira a data, o conteúdo e o arquivo da avaliação. O CURIÓ não inventa uma nota antes da correção da professora.</p></div></section>
