...
export default async function StudentTestModePage(){
  ...
  return <>
    <PageHeader eyebrow="Explorador Plumareli" title="Modo Prova" description="Veja as próximas avaliações, organize sua revisão e acompanhe os resultados que a professora publicar."/>
    <section className="student-test-intro"><span className="student-test-intro-icon"><CurioIcon name="check" /></span><div><h2>Preparar também é aprender.</h2><p>Confira a data, o conteúdo e o arquivo da avaliação. O PLUMARELI não inventa uma nota antes da correção da professora.</p></div></section>
