...
export default async function StudentProfilePage({searchParams}:{searchParams:Promise<{erro?:string;sucesso?:string}>}) {
  ...
  return <>
    <PageHeader eyebrow="Explorador Plumareli" title="Meu perfil" description="Deixe o PLUMARELI do seu jeito. Seu avatar acompanha você pelo portal e aparece para quem acompanha sua jornada."/>
