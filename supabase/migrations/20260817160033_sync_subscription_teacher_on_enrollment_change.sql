...
begin
  ...
  set active = false
  where student_id = v_inv.student_id
  ...
  if v_subscription_id is null then
    insert into public.subscriptions(guardian_id,student_id,plan_id,teacher_id,status,agreed_monthly_price,starts_at)
    values (v_guardian_id,v_inv.student_id,p_plan_id,p_teacher_id,'pending',v_price,current_date)
